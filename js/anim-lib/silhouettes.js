...
function silhouette_outline_d(form_n, x, y) {
  ...
  if (form_n == 0) {
    return (
      ...
      "," +
      (y + 19.7) +
      "c2.7,0,5.5,-1,5.5,-1c0,-1.8,-0.8,-5.6,-0.8,-5.6c-0.5,-1.7,-0.6,-3.6,-0.1,-4.7C" +
      (x + 15) +
      "," +
      (y + 7.3) +
      "," +
      ...
      "," +
      (y + 0) +
      "l-1.3,0c0,0,0.6,5.2,-2.8,5.1h0C" +
      (x + 6.6) +
      "," +
      (y + 5.2) +
      "," +
      ...
      "," +
      (y + 8.4) +
      "c0.5,1.2,0.4,3,-0.1,4.7c0,0,-0.8,3.8,-0.8,5.6C" +
      (x + 4.5) +
      "," +
      (y + 18.7) +
      "," +
