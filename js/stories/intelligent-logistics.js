...
var persisted_lines_data = [
  {
    ...
    x1: 200,
    x2: wh_logistics[0].x,
    y1: wh_logistics[0].y + 20,
    y2: wh_logistics[0].y + 20,
  },
  {
    t: 9500,
    x1: wh_logistics[0].x,
  ...
  },
  {
    t: 10000,
    x1: wh_logistics[1].x,
    x2: wh_logistics[2].x - 15,
    y1: wh_logistics[0].y + 20,
    y2: wh_logistics[0].y + 20,
  },
  {
    t: 10500,
    x1: wh_logistics[2].x - 15,
    x2: wh_logistics[2].x - 15,
    y1: wh_logistics[0].y + 20,
    y2: wh_logistics[2].y + 20,
  },
  {
    t: 11000,
    x1: wh_logistics[2].x - 15,
    x2: wh_logistics[2].x,
    y1: wh_logistics[2].y + 20,
    y2: wh_logistics[2].y + 20,
  },
  {
    t: 11500,
  ...
  picker: {
    ...
    progression: [
      { t: 8500, cx: 200, cy: wh_logistics[0].y + 20, i: "linear" },
      {
        t: 9000,
        cx: wh_logistics[0].x,
        cy: wh_logistics[0].y + 20,
        i: "linear",
      },
      {
        t: 9500,
        cx: wh_logistics[1].x,
        cy: wh_logistics[1].y + 20,
        i: "linear",
      },
      {
        t: 10000,
        cx: wh_logistics[2].x - 15,
        cy: wh_logistics[1].y + 20,
        i: "linear",
      },
      {
        t: 10500,
        cx: wh_logistics[2].x - 15,
        cy: wh_logistics[2].y + 20,
        i: "linear",
      },
      {
        t: 11000,
        cx: wh_logistics[3].x,
        cy: wh_logistics[3].y + 20,
        i: "linear",
      },
      {
        t: 11500,
        cx: wh_logistics[3].x,
        cy: wh_logistics[4].y - 20,
        i: "linear",
      },
      {
        t: 12000,
...
for (var i = 0; i < 5; i++) {
  logistics_fix_elements["selection" + i] = {
    ...
    fill: "#58595b",
    stroke: "none",
    form_n: copy_selected_items[i].sil_n,
    dx: 0,
    dy: 0,
    progression: [
      ...
      {
        t: 7000,
        x: wh_logistics[i].x - 10,
        y: wh_logistics[i].y - 10,
        i: "linear",
      },
    ],
  };
...
for (var i = 0; i < other_wh_logistics.length; i++) {
  logistics_fix_elements["other_styleoutline" + i] = {
    ...
    fill: "none",
    stroke: "#777",
    form_n: Math.floor(Math.random() * 7),
    dx: 0,
    dy: 0,
    progression: [
      {
        t: 5500,
        x: other_wh_logistics[i].x - 10,
        y: other_wh_logistics[i].y - 10,
        i: "linear",
      },
      {
        t: 14000,
...
logistics_fix_elements["styleoutline" + i] = {
  ...
  fill: "#fff",
  stroke: "#000",
  form_n: copy_selected_items[0].sil_n,
  dx: outline_locs[i].dx,
  dy: outline_locs[i].dy,
  progression: [
    {
      t: 7000,
      x: wh_logistics[i].x - 10,
    ...
    },
    {
      t: 9000,
      x: wh_logistics[i].x - 10,
      y: wh_logistics[i].y - 10 + 20,
      i: "linear",
    },
    {
      t: 9500,
      x: wh_logistics[1].x - 10,
      y: wh_logistics[1].y + 20 - 10,
      i: "linear",
    },
    {
      t: 10000,
      x: wh_logistics[2].x - 15 - 10,
      y: wh_logistics[1].y + 20 - 10,
      i: "linear",
    },
    {
      t: 10500,
      x: wh_logistics[2].x - 15 - 10,
      y: wh_logistics[2].y + 20 - 10,
      i: "linear",
    },
    {
      t: 11000,
      x: wh_logistics[3].x - 10,
      y: wh_logistics[3].y + 20 - 10,
      i: "linear",
    },
    {
      t: 11500,
      x: wh_logistics[3].x - 10,
      y: wh_logistics[4].y - 20 - 10,
      i: "linear",
    },
    {
      t: 12000,
      x: wh_logistics[4].x - 10,
      y: wh_logistics[4].y - 20 - 10,
      i: "linear",
    },
    ...
    {
      t: 14000,
      x: outline_locs[i].dx + 385,
      y: outline_locs[i].dy + 220,
      a: -56,
      i: "circular",
    },
...
logistics_fix_elements["styleoutline" + i] = {
  ...
  fill: "#fff",
  stroke: "#000",
  form_n: copy_selected_items[2].sil_n,
  dx: outline_locs[i].dx,
  dy: outline_locs[i].dy,
  progression: [
    {
...
logistics_fix_elements["styleoutline" + i] = {
  ...
  fill: "#fff",
  stroke: "#000",
  form_n: copy_selected_items[4].sil_n,
  dx: outline_locs[i].dx,
  dy: outline_locs[i].dy,
  progression: [
    {
...
logistics_fix_elements["styleoutline" + i] = {
  ...
  fill: "#fff",
  stroke: "#000",
  form_n: copy_selected_items[1].sil_n,
  dx: outline_locs[i].dx,
  dy: outline_locs[i].dy,
  progression: [
    {
...
logistics_fix_elements["styleoutline" + i] = {
  ...
  fill: "#fff",
  stroke: "#000",
  form_n: copy_selected_items[3].sil_n,
  dx: outline_locs[i].dx,
  dy: outline_locs[i].dy,
  progression: [
    {
...
function draw_warehouse_animation_lines() {
  d3.select("#logistics-dist-function")
    .append("line")
    .attr("x1", 324 + 112)
    .attr("x2", 324 + 112)
    .attr("y1", 110)
...
function logistics_fix_sim(t) {
  ...
  if (t > 17000 && t < 18000) {
    d3.selectAll(
      "#icycle2vec-greenbox, #icycle2vec-blueboxes, #icycle2vec-greenarrows"
    )
      .attr("display", "block")
      .style("opacity", 1);
    if (!animation_state.icycle2vec_animation_interval) {
      start_icycle2vec_animation();
    }
  } else {
  ...
  if (t > 18500) {
    ...
    d3.select("#icycle-closet").attr("display", "none").style("opacity", 0);
  }
  ...
  Object.keys(logistics_fix_elements).forEach(function (el_name) {
    ...
    var i =
      -1 +
      el.progression.findIndex(function (d) {
        return t <= d.t;
      });
    ...
    if (i <= -1) {
      // remove element(s)
      d3.select("#logistics-fix-sim")
        .selectAll(".logistics-fix-sim-" + el_name + "-" + sim_number)
        .remove();
    }
    if (i > -1) {
      ...
      // move element(s)
      var dt =
        (t - el.progression[i].t) /
        (el.progression[i + 1].t - el.progression[i].t);
      if (el.type == "circle") {
        if (el.progression[i].i == "linear") {
          ...
          d3.select("#logistics-fix-sim")
            ...
            .attr(
              "cx",
              el.progression[i].cx * (1 - de) + el.progression[i + 1].cx * de
            )
            .attr(
              "cy",
              el.progression[i].cy * (1 - de) + el.progression[i + 1].cy * de
            );
        }
        if (el.progression[i].i == "circular") {
          var de = d3.easePoly(dt, 1);
          var da =
            el.progression[i].a * (1 - de) + el.progression[i + 1].a * de;
          d3.select("#logistics-fix-sim")
            .selectAll(".logistics-fix-sim-" + el_name + "-" + sim_number)
            .attr(
              "cx",
              el.dx +
                icycle_center.x +
                icycle_radius * Math.cos(da * (Math.PI / 180))
            )
            .attr(
              "cy",
              el.dy +
                icycle_center.y +
                icycle_radius * Math.sin(da * (Math.PI / 180))
            );
        }
      }
      if (el.type == "path") {
        if (el.progression[i].i == "linear") {
          var de = d3.easePoly(dt, 1.5);
          var tx =
            el.progression[i].x * (1 - de) + el.progression[i + 1].x * de;
          var ty =
            el.progression[i].y * (1 - de) + el.progression[i + 1].y * de;
          d3.select("#logistics-fix-sim")
            .selectAll(".logistics-fix-sim-" + el_name + "-" + sim_number)
      ...
      if (el.type == "note_path") {
        if (el.progression[i].i == "linear") {
          var de = d3.easePoly(dt, 1.5);
          var tx =
            el.progression[i].x * (1 - de) +
            el.progression[i + 1].x * de -
            455.5;
          var ty =
            el.progression[i].y * (1 - de) + el.progression[i + 1].y * de - 189;
          d3.select("#logistics-fix-sim")
            .selectAll(".logistics-fix-sim-" + el_name + "-" + sim_number)
