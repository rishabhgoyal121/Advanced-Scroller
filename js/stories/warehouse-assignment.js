...
var color_palette_warehouses = d3.scale
  .ordinal()
...
function swa_0() {
  ...
  d3.select("#swa-map-outline")
    ...
    .attr("fill", function (d, i) {
      return color_palette_warehouses(i);
    })
    .attr("r", 3)
    .style("opacity", 0);

  d3.select("#swa-map-outline")
    .selectAll(".hizzy_client1_line")
    .data(hizzy_data)
    .enter()
    .append("line")
  ...
  d3.select("#swa-map-outline")
    .selectAll(".client1_dot")
    .data(client1_dot_data)
    .enter()
    .append("circle")
  ...
  d3.select("#swa-cost-calc").style("opacity", 0);

  d3.select("#swa-cost-matrix-top-line").style("opacity", 0);
}
...
function swa_1() {
  ...
  d3.select("#swa-map-outline")
    .selectAll(".many_clients_dot")
    .data(many_clients_data)
    .enter()
    .append("circle")
...
function swa_2() {
  d3.select("#swa-cost1")
    .transition()
    .duration(0)
    .attr("transform", "matrix(1 0 0 1 316.3404 355.7868)");
  d3.select("#swa-cost2")
    .transition()
    .duration(0)
    .attr("transform", "matrix(1 0 0 1 364.56 355.7868)");
  d3.select("#swa-cost3")
    .transition()
    .duration(0)
    .attr("transform", "matrix(1 0 0 1 412.7801 355.7868)");
  d3.select("#swa-cost4")
    .transition()
    .duration(0)
    .attr("transform", "matrix(1 0 0 1 461.0002 355.7868)");
  d3.select("#swa-cost5")
    .transition()
    .duration(0)
    .attr("transform", "matrix(1 0 0 1 509.1 355.7868)");

  d3.selectAll("#swa-cost4, #swa-cost5").style("opacity", 0);
}
...
function swa_4() {
  ...
  d3.select("#swa-map-outline")
    ...
    .attr("fill", function (d, i) {
      return color_palette_warehouses(1);
    })
    .attr("r", 6)
    .style("opacity", 0);
