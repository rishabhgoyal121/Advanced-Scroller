...
activateFunctions.push(function () {
  ...
  overview_reset();
  d3.selectAll(
    "#sketch-styling-circle, #sketch-inventory, #sketch-clients, #sketch-client-selected"
  )
    .transition()
    .duration(0)
    .attr("display", "none")
...
activateFunctions.push(function () {
  ...
  d3.selectAll(
    "#sketch-stylist, #sketch-machines, #sketch-styling-circle, #sketch-stylingAlgo, #sketch-animation-labels, #sketch-animation"
  )
    .transition()
    .duration(0)
    .attr("display", "block");
...
activateFunctions.push(function () {
  ...
  highlight_svg_groups([
    ...
    "sketch-client-selected",
    "sketch-styling-circle",
    "sketch-client-profile",
    "sketch-clothing-profile",
    "sketch-client-profile",
    "sketch-clothing-profile",
  ]);
...
updateFunctions.push(function (progress) {
  ...
  d3.selectAll("#sketch-client-selected")
    ...
    .attr(
      "transform",
      "translate(" + 80 * progress2 + "," + 175 * progress2 + ")"
    );
...
activateFunctions.push(function () {
  ...
  highlight_svg_groups([
    ...
    "profile",
    "wh2",
    "swa-label-cost-matrix",
    "swa-cost-calc",
    "swa-cost-matrix",
    "swa-map-outline",
    "swa-cost-matrix-top-line",
  ]);
...
activateFunctions.push(function () {
  ...
  d3.select("#machines").attr("transform", "translate(0,0) scale(1)");
});

updateFunctions.push(function (progress) {
  // fade out the smart-warehouse-assignment material
  d3.selectAll(
    "swa-label-cost-matrix, #swa-label-opt, #swa-assignment-matrix, #swa-opt-function, #swa-cost-calc, #swa-cost-matrix, #swa-map-outline, #swa-cost-matrix-top-line"
  )
    .transition()
    .duration(0)
    .attr("display", "block")
...
activateFunctions.push(function () {
  ...
  highlight_svg_groups([
    ...
    "recsyslegend-base",
    "recsyslegend-colfil",
    "rec-sys-match-scores",
    "rec-sys-match-row-text",
  ]);

  // show the collaborative filtering arc and legend entry
  color_boxes_by_algo_score(
    d3.select("#animation-zone-algo-vis"),
    algo_scores,
...
activateFunctions.push(function () {
  ...
  highlight_svg_groups([
    ...
    "rec-sys-explicit-features",
    "rec-sys-latent-features",
    "animated-fit-learning-narrative",
  ]);
  ...
  stop_animation_interval("latent_size_meta2_interval");
  if (page_state.fit_scroll_prev_loc != 0) {
    latent_size_animation_1();
  }
...
activateFunctions.push(function () {
  ...
  stop_animation_interval("latent_size_meta1_interval");
  if (page_state.fit_scroll_prev_loc != 2) {
    latent_size_animation_2();
  }
...
updateFunctions.push(function (progress) {
  ...
  d3.selectAll(
    "#rec-sys-match-scores, #rec-sys-explicit-features, #rec-sys-latent-features"
  ).style("opacity", 1 - progress);
});
...
updateFunctions.push(function (progress) {
  ...
  d3.selectAll(
    "#recsyslegend-base, #recsyslegend-colfil, #recsyslegend-mem, #recsyslegend-cnn, #recsyslegend-nlp"
  ).style("opacity", 1 - progress);
  d3.selectAll(
    ".algo-name-text-1, .algo-name-text-2, .algo-name-text-3, .algo-name-text-4"
  ).style("opacity", 1 - progress);
...
updateFunctions.push(function (progress) {
  ...
  d3.select("#mm-matchscore-calc")
    ...
    .attr(
      "transform",
      "translate(" + 450 * Math.min(1, 2 - 2 * progress) + ",0)"
    );
});
...
updateFunctions.push(function (progress) {
  ...
  d3.selectAll(
    "swa-label-cost-matrix, #swa-label-opt, #mm-matchscore-calc, #mm-opt-function, #mm-cost-matrix, #mm-assignment-matrix"
  )
    .transition()
    .duration(0)
    .attr("display", "block")
...
activateFunctions.push(function () {
  ...
  highlight_svg_groups([
    ...
    "h-algo",
    "animation-zone-algo-vis",
    "stylist-ui-sketch-background",
    "stylist-ui-sketch-lines",
  ]);
...
activateFunctions.push(function () {
  ...
  d3.select(".stylist_note_dot").style("opacity", 1);
});
...
activateFunctions.push(function () {
  ...
  // overriding the above highlight_svg_groups timing for this handoff
  d3.selectAll(
    "#animation-zone-algo-vis, #humans, #machines, #the-algo, #icycle-newlabel-sr"
  )
    .transition()
    .duration(0)
    .style("opacity", 0);
...
activateFunctions.push(function () {
  ...
  highlight_svg_groups([
    ...
    "icycle-machines",
    "logistics-fix-sim",
    "logistics-opt-function",
    "logistics-dist-function",
  ]);
...
activateFunctions.push(function () {
  ...
  d3.selectAll("#calendar, #profile, #wh2")
    .transition()
    .duration(0)
    .style("opacity", 0);
...
activateFunctions.push(function () {
  ...
  highlight_svg_groups([
    ...
    "icycle-machines",
    "single-fix-sim",
    "single-fix-sim-labels",
    "client1",
    "legend-client-profiles",
    "legend-fix-requests",
    "legend-warehouse-assignment",
    "legend-fix-selections",
    "legend-stylist-notes",
    "legend-feedback",
    "legtext-client-profiles",
    "legtext-fix-requests",
    "legtext-fix-selections",
    "legtext-stylist-notes",
    "legtext-feedback",
  ]);
...
updateFunctions.push(function (progress) {
  // like butter
  d3.selectAll(
    "#inventory-cycle, #machines, #humans, #humans-unselected, #the-algo, #inventory-cycle-sim-labels, #icycle-warehouses, #icycle-machines, #icycle-newlabel-wa, #icycle-newlabel-sr, #icycle-newlabel-lo, #legend-client-profiles, #legend-fix-requests, #legend-warehouse-assignment, #legend-fix-selections, #legend-stylist-notes, #legend-feedback, #legtext-client-profiles, #legtext-fix-requests, #legtext-fix-selections, #legtext-stylist-notes, #legtext-feedback, #icycle-merch-algo"
  )
    .transition()
    .duration(0)
    .style("opacity", Math.max(0, 1 - 2 * progress));
...
activateFunctions.push(function () {
  ...
  run_inventory_management_sim(
    ...
    (inputs = true),
    (model = false),
    (clothing_animation = true),
    (detailed_colors = false),
    (show_q_t = true),
    (nonzero_replenish = false)
  );
});
...
updateFunctions.push(function (progress) {
  ...
  d3.selectAll(
    "#state-transitions, #state-transitions-animation, #demand-model-equation"
  )
    .transition()
    .duration(0)
    .attr("display", "block")
    .style("opacity", Math.max(0, 1 - 4 * progress));
  d3.selectAll(
    "#im-qt-graph-equations, #im-clients, #im-clients-serving-single, #im-capacities-single, #im-purchase-single, #im-wh-outlines-single, #im-labels-single, #im-warehouse-labels-single, #im-labels-purchase, #icycle-merch-algo2, #im-clothing-animation"
  )
    .transition()
    .duration(0)
    .attr("display", "block")
...
activateFunctions.push(function () {
  ...
  run_inventory_management_sim(
    ...
    (inputs = true),
    (model = false),
    (clothing_animation = false),
    (detailed_colors = false),
    (show_q_t = false),
    (nonzero_replenish = true)
  );
});
...
updateFunctions.push(function (progress) {
  ...
  d3.selectAll(
    "#im-clients, #im-clients-serving, #im-capacities, #im-purchase, #im-allocation, #im-wh-outlines, #im-labels-purchase, #im-clients-selected"
  )
    .transition()
    .duration(0)
    .attr("display", "block")
...
activateFunctions.push(function () {
  ...
  d3.selectAll(
    "#nsd-ea-initial-population-rect, #nsd-ea-selection-rect, #nsd-ea-recombination-rect, #nsd-ea-mutation-rect, #nsd-ea-next-population-rect"
  ).attr("fill", "none");
  d3.selectAll(
    "#nsd-ea-initial-population-text, #nsd-ea-selection-text, #nsd-ea-recombination-text, #nsd-ea-mutation-text, #nsd-ea-next-population-text"
  ).attr("fill", "#847c77");
...
activateFunctions.push(function () {
  ...
  d3.selectAll(
    "#nsd-ea-selection-rect, #nsd-ea-recombination-rect, #nsd-ea-mutation-rect, #nsd-ea-next-population-rect"
  ).attr("fill", "none");
  d3.selectAll(
    "#nsd-ea-selection-text, #nsd-ea-recombination-text, #nsd-ea-mutation-text, #nsd-ea-next-population-text"
  ).attr("fill", "#847c77");
});
...
activateFunctions.push(function () {
  ...
  d3.selectAll(
    "#nsd-fadeout, #nsd-top-set, #nsd-bottom-set, #nsd-attrs-blouse, #nsd-attrs-neckline, #nsd-attrs-sleeve, #nsd-attrs-pattern, #nsd-attrs-color, #nsd-attrs-sizeratio, #nsd-attrs-squiggle, #nsd-attrs-number, #nsd-attrs-greyscale, #nsd-attrs-other"
  )
    .transition()
    .duration(1000)
    .attr("display", "block")
  ...
  d3.selectAll("#nsd-ea-initial-population-rect, #nsd-ea-selection-rect").attr(
    "fill",
    "#4B90A6"
  );
  d3.selectAll("#nsd-ea-initial-population-text, #nsd-ea-selection-text").attr(
    "fill",
    "#000"
  );
  d3.selectAll(
    "#nsd-ea-recombination-rect, #nsd-ea-mutation-rect, #nsd-ea-next-population-rect"
  ).attr("fill", "none");
  d3.selectAll(
    "nsd-ea-recombination-text, #nsd-ea-mutation-text, #nsd-ea-next-population-text"
  ).attr("fill", "#847c77");
});
...
activateFunctions.push(function () {
  ...
  highlight_svg_groups([
    ...
    "nsd-bottom-set",
    "nsd-top-set-stars",
    "nsd-bottom-set-stars",
  ]);

  // move the top half of the clothes upward..
  d3.selectAll(
    "#nsd-top-set, #nsd-top-set-stars, #nsd-attrs-blouse, #nsd-attrs-neckline, #nsd-attrs-sleeve, #nsd-attrs-pattern, #nsd-attrs-color, #nsd-attrs-sizeratio, #nsd-attrs-squiggle, #nsd-attrs-number, #nsd-attrs-greyscale, #nsd-attrs-other"
  )
    .transition()
    .duration(1000)
  ...
  animation_state.frankenstyle_animation_interval = setInterval(
    create_frankenstyle,
    2000
  );
  create_frankenstyle();
  ...
  d3.selectAll("#nsd-ea-recombination-rect, #nsd-ea-mutation-rect").attr(
    "fill",
    "#4B90A6"
  );
  d3.selectAll("#nsd-ea-recombination-text, #nsd-ea-mutation-text").attr(
    "fill",
    "#000"
  );
  d3.selectAll(
    "#nsd-ea-initial-population-rect, #nsd-ea-selection-rect, #nsd-ea-next-population-rect"
  ).attr("fill", "none");
  d3.selectAll(
    "#nsd-ea-initial-population-text, #nsd-ea-selection-text, #nsd-ea-next-population-text"
  ).attr("fill", "#847c77");
});
...
activateFunctions.push(function () {
  ...
  d3.selectAll(
    "#nsd-ea-initial-population-rect, #nsd-ea-selection-rect, #nsd-ea-recombination-rect, #nsd-ea-mutation-rect"
  ).attr("fill", "none");
  d3.selectAll(
    "#nsd-ea-initial-population-text, #nsd-ea-selection-text, #nsd-ea-recombination-text, #nsd-ea-mutation-text"
  ).attr("fill", "#847c77");
});
...
activateFunctions.push(function () {
  ...
  d3.selectAll("#nsd-ea-next-population-rect, #nsd-ea-selection-rect").attr(
    "fill",
    "#4B90A6"
  );
  d3.selectAll("#nsd-ea-next-population-text, #nsd-ea-selection-text").attr(
    "fill",
    "#000"
  );
  d3.selectAll(
    "#nsd-ea-initial-population-rect, #nsd-ea-recombination-rect, #nsd-ea-mutation-rect"
  ).attr("fill", "none");
  d3.selectAll(
    "#nsd-ea-initial-population-text, #nsd-ea-recombination-text, #nsd-ea-mutation-text"
  ).attr("fill", "#847c77");
});
...
updateFunctions.push(function (progress) {
  ...
  d3.selectAll(
    "#nsd-bottom-set, #nsd-top-set, #nsd-bottom-set-stars, #nsd-top-set-stars, #nsd-attrs-blouse, #nsd-attrs-neckline, #nsd-attrs-sleeve, #nsd-attrs-pattern, #nsd-attrs-color, #nsd-attrs-sizeratio, #nsd-attrs-squiggle, #nsd-attrs-number, #nsd-attrs-greyscale, #nsd-attrs-other"
  )
    .transition()
    .duration(0)
    .attr("display", "block")
...
activateFunctions.push(function () {
  ...
  highlight_svg_groups([
    "platform-data-circles",
    "platform-data-top",
    "platform-data-frame",
    "platform-compute",
    "platform-prodlines",
    "platform-datascientist",
    "platform-ds-typing",
    "platform-animation-ingestion",
    "platform-animation-api",
    "platform-animation-adds",
  ]);

  // make sure the necessary svg groups are visible for the platform animation
  d3.selectAll(
    "#platform-animation-datanado, #platform-animation, #platform-animation-2, #platform-data-circles, #platform-data-top, #platform-data-frame, #platform-compute, #platform-prodlines, #platform-datascientist, #platform-ds-typing, #platform-animation-ingestion, #platform-animation-api, #platform-animation-adds"
  )
    .transition()
    .duration(0)
    .attr("display", "block")
  ...
  d3.select("#vis > svg").transition().duration(0).attr("display", "block");
...
updateFunctions.push(function (progress) {
  ...
  if (progress > 1.5) {
    ...
    d3.select("#vis > svg").transition().duration(0).attr("display", "none");
  } else {
